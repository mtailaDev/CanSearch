...
class QuickSearchAdapter(val quickSearchList: List<String>) : RecyclerView.Adapter<QuickSearchAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuickSearchAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(viewHolder: QuickSearchAdapter.ViewHolder, position: Int) {
